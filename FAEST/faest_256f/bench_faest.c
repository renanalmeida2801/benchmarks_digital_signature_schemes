 ...
 *
 * Nota: CRYPTO_BYTES no FAEST é 5924 — significativamente maior
 * que o Mirath. O buffer sm é dimensionado automaticamente via
 * CRYPTO_BYTES + mlen.
 * ───────────────────────────────────────────────────────────── */
...
/* ─────────────────────────────────────────────────────────────
 * setup() — Gera par de chaves e assinatura de referência.
 *
 * Diferença em relação ao Mirath: o FAEST não usa randombytes_init
 * com semente explícita — a aleatoriedade vem do sistema operacional
 * via randomness_os.c, portanto nenhuma inicialização é necessária.
 * ───────────────────────────────────────────────────────────── */
